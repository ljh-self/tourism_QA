...
import sys, os
# Disable
from mytest.test01.test1 import Question_classify

from mytest.test01.question_template import QuestionTemplate
...
class Question():
    ...
    def init_config(self):
        ...
        with(open("../test01/vocabulary.txt", "r", encoding="utf-8")) as fr:
        ...
        with(open("../test01/classfication.txt", "r", encoding="utf-8")) as f:
